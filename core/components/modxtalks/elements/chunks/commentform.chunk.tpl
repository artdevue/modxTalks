...
<div id="mt_cf_conversationReply">
	<form action="[[+link]]" method="post" enctype="multipart/form-data">
		...
		<div class="mt_post mt_hasControls mt_edit" id="mt_replay">
			<div class="mt_avatar"><img src="[[+avatar]]" alt="" class="mt_avatar_img"></div>
			<div class="mt_postContent mt_thing">
				<div class="mt_form_editor_buttons">
					<div class="mt_info">
						[[+write_comment]]
					</div>
					<div class="mt_controls">
						<span class="mt_formattingButtons">[[+controlsbb]]</span>
						<label class="mt_previewCheckbox"><input type="checkbox" id="reply-previewCheckbox" onclick="MTConversation.togglePreview('mt_replay', this.checked)" accesskey="p"> [[+previewCheckbox]]</label>
					</div>
				</div>
				<div class="mt_postBody">
					<textarea cols="200" rows="20" tabindex="200" name="content" class="mt_text" style="height: 200px;overflow: hidden" autocomplete="off"></textarea>
					<div id="mt_replay-preview" class="mt_preview"></div>
		...
		<span id="mt_replay-bg" class="mt_buttonGroup[[+hidden]]">
