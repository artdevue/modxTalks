...
class modxTalksConversation extends xPDOSimpleObject
{
	...
	public function syncCommentsCount()
	{
		...
		$total = $this->xpdo->getCount('modxTalksPost', ['conversationId' => $this->id]);
		$deleted = $this->xpdo->getCount('modxTalksPost', ['conversationId' => $this->id, 'deleteUserId:>' => 0]);
		$unconfirmed = $this->xpdo->getCount('modxTalksTempPost', ['conversationId' => $this->id]);
