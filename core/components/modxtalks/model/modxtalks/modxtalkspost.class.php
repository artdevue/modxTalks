...
class modxTalksPost extends xPDOSimpleObject
{
	...
	public function addVote($userId)
	{
		...
		$votes = ! empty($votes) ? $votes : [$users => [], $total => 0];
