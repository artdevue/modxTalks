...
$_lang['modxtalks.prop_gravatarSize_desc'] = 'Размер аватара выводимого в комментариях через сервис Граватар.';
$_lang['modxtalks.prop_defaultAvatar_desc'] = 'Полная ссылка на аватар, отображается при отсутствии аватара через сервис Граватар.';
$_lang['modxtalks.prop_dateFormat_desc'] = 'Формат даты отображаемой в комментариях.';
...
$_lang['modxtalks.prop_commentAuthTpl_desc'] = 'Шаблон формы регистрации. Выводиться не авторизированным юзерам, если параметр onlyAuthUsers активный.';
