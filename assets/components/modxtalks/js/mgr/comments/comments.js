Ext.onReady(function () {
	...
	var rec = res.properties || { modxtalks: {} };
	var total = 0;
	Ext.Ajax.request({
		...
		items: [{
			...
			items: [{
				...
				items: [{
					...
					store: [
						['', _('modxtalks.default')],
						['10', '10 ' + _('modxtalks.comments')],
						['15', '15 ' + _('modxtalks.comments')],
						['20', '20 ' + _('modxtalks.comments')],
						['25', '25 ' + _('modxtalks.comments')],
						['30', '30 ' + _('modxtalks.comments')],
						['35', '35 ' + _('modxtalks.comments')],
						['40', '40 ' + _('modxtalks.comments')],
						['45', '45 ' + _('modxtalks.comments')],
						['50', '50 ' + _('modxtalks.comments')],
						['100', '100 ' + _('modxtalks.comments')],
						['200', '200 ' + _('modxtalks.comments')]
					],
					mode: 'local',
					triggerAction: 'all',
