...
switch ($action) {
    ...
    case        'add':
        ...
        break;
    case       'like':
        $processor = 'web/comment/like';
        break;
    case      'quote':
        $processor = 'web/comment/quote';
        break;
    case     'delete':
        $processor = 'web/comment/remove';
        break;
    case    'restore':
        $processor = 'web/comment/restore';
        break;
    case       'edit':
        $processor = 'web/comment/update';
        break;
    case        'get':
        $processor = 'web/comment/get';
        break;
    case       'vote':
        $processor = 'web/comment/vote';
        break;
    case 'votes_info':
        $processor = 'web/comment/votes_info';
        break;
    case  'ban_email':
        $processor = 'web/comment/block_email';
        break;
    case     'ban_ip':
        $processor = 'web/comment/block_ip';
        break;
    case       'load':
        $processor = 'web/comments/load';
        break;
    case     'latest':
        $_POST['action'] = $action;
        $processor = 'web/comments/latest';
        break;
    default:
        return;
        break;
